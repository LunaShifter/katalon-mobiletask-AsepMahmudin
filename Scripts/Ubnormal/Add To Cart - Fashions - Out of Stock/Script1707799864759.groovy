...
Mobile.tap(findTestObject('Object Repository/Add to Cart All Products/android.widget.TextView - Fashions'), 0)

Mobile.tap(findTestObject('Object Repository/Add to Cart All Products/android.widget.ImageView'), 0)

Mobile.tap(findTestObject('Object Repository/Add to Cart All Products/android.widget.Button - ADD TO CART'), 0)

Mobile.setText(findTestObject('Object Repository/Add to Cart All Products/android.widget.EditText'), '50', 0)
