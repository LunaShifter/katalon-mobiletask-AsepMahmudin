...
Mobile.tap(findTestObject('Object Repository/Add to Cart/android.widget.TextView - Electronics  Gadgets'), 0)
...
Mobile.setText(findTestObject('Object Repository/Add to Cart/android.widget.EditText'), '35', 0)
